...
const MealForm = ({input, callback, goBack}) => {
    ...
    const submit = (e, name) => {
        ...
        if (index === input.acceptCount - 1) {
            ...
            output.responses = [...output.responses, ...input.responses.filter((response) => !response.accepted)];
            console.log(output);
    ...
    if (input && input.responses) {
        return (
            <Carousel className="meal_form" activeIndex={index} onSelect="" controls={false} indicators={false} nextLabel={null} >
                {
                    ...
                    <Form onSubmit={(e) => submit(e, person.name)}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control as="select" custom required onChange={(e) => setStarter(e.target.value)}>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control as="select" custom required onChange={(e) => setMain(e.target.value)}> 
                                <option value="" selected disabled>Please select</option>
                        ...
                        <Form.Group>
                            ...
                            <Form.Control as="select" custom required onChange={(e) => setDessert(e.target.value)}>
                                <option value="" selected  disabled>Please select</option>
                        ...
                        <Form.Row>
                            <Button className="back" variant="secondary" onClick={handleGoBack}>Back</Button>
