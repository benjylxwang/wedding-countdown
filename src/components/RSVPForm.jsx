...
const RSVPForm = ({ frontmatter, handleRSVPSuccess }) => {
  const {
    rsvpNameLabel,
    rsvpEmailLabel,
    rsvpInviteCodeLabel,
  ...
  const handleSubmit = (evt) => {
    ...
    if (
      md5(inviteCode) !== "d6398f47dd797f497e45e5a6ad02baf5" &&
      ...
      fetch(
        "https://script.google.com/macros/s/AKfycbwX1k4Pu9ACp2_7JkD5ACKRvPX_vNCs1olpNd7aly3w8fxVMAI/exec",
        {
          method: "POST",
          redirect: "follow",
          body: formData,
            ...
            <Form.Row className="text-center">
              ...
              <Col md={4}>
                <Form.Control
                  ...
                  placeholder={rsvpInviteCodeLabel}
                  required
                />
              </Col>
            </Form.Row>
